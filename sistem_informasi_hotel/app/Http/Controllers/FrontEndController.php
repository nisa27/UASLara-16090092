...
class FrontEndController extends Controller
{
    public function index()
    {
        ...
        $kamar_list  = Kamar::where('deleted', '0')->orderBy('id', 'desc');
    ...
    public function edit(Kamar $kamar)
    {
        ...
        $tipekamar_list = Tipekamar::pluck('tipe_kamar', 'id');
        return view('back-end.kamar.edit', compact('kamar', 'tipekamar_list'));
    }
    ...
    public function fiture()
    {
        $fasilitas_list  = Fasilitas::orderBy('nama_fasilitas', 'asc')->paginate(10);
        return view('front-end.fiture',compact('fasilitas_list'));
    }
     public function show(Kamar $kamar)
    {
        //$kamar = Kamar::findOrFail($id);
        return view('front-end.detail_kamar', compact('kamar')); 
    }
    //pesan konfirmasi
    public function pesan()
    {
       return redirect('rooms')->with(['success' => 'Terimakasih']);
    }
    public function cetak_pdf()
    {
        $pesan = $book->kode_booking;
 
        $pdf = PDF::loadview('booking_pdf',['pesan'=>$pesan]);
        return $pdf->download('Kode-booking-pdf');
    }
