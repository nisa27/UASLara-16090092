    ...
    */
    ...
    'custom' => [
        ...
        'nama_kelas' => [
            ...
            'string' => 'Nama kelas harus berisi string',
            'max'   => 'Nama kelas maximal 20 karakter',
        ],
        'nama_hobi' => [
            'required' => 'Nama hobi harus diisi',
            'string' => 'Nama hobi harus berisi string',
            'max'   => 'Nama hobi maximal 20 karakter',
        ],
        'email' => [
        ...
        'password' => [
            'confirmed' => 'Password tidak cocok dengan kolom confirm password.',
            'min'       => 'Password minimal 6 karakter',
        ],
        'no_kamar' => [
            'required' => 'No Kamar harus diisi.',
            'unique'    => 'No Kamar sudah terdaftar',
        ],
        'nama_kamar' => [
            'required' => 'Nama Kamar harus diisi.',
            'string' => 'Nama Kamar harus berisi string',
            'max'   => 'Nama Kanar maximal 20 karakter',
        ],
        'harga' => [
