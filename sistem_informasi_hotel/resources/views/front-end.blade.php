...
<div class="super_container">
	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			<div class="logo"><a href="#">Noor</a></div>
	...
	<div class="home">
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slide -->
				<div class="slide">
					<div class="background_image" style="background-image:url(assets/img/index_1.jpg)"></div>
			...
			<div class="row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="assets/img/icon_1.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="assets/img/icon_2.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box d-flex flex-column align-items-center justify-content-start text-center">
						<div class="icon_box_icon"><img src="assets/img/icon_3.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
		...
		<div class="gallery_slider_container">
			<div class="owl-carousel owl-theme gallery_slider">
				...
				<div class="gallery_item">
					<div class="background_image" style="background-image:url(assets/img/gallery_1.jpg)"></div>
					<a class="colorbox" href="assets/img/gallery_1.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url(assets/img/gallery_2.jpg)"></div>
					<a class="colorbox" href="assets/img/gallery_2.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url(assets/img/gallery_3.jpg)"></div>
					<a class="colorbox" href="assets/img/gallery_3.jpg"></a>
				</div>

				<!-- Slide -->
				<div class="gallery_item">
					<div class="background_image" style="background-image:url(assets/img/gallery_4.jpg)"></div>
					<a class="colorbox" href="assets/img/gallery_4.jpg"></a>
				</div>
	...
	<div class="testimonials">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="assets/img/testimonials.jpg" data-speed="0.8"></div>
					...
					<div class="testimonials_slider_container">
						...
						<div class="owl-carousel owl-theme test_slider">
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="assets/img/user_1.jpg" alt=""></div>
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="assets/img/user_2.jpg" alt=""></div>
							...
							<div  class="test_slider_item text-center">
								...
								<div class="testimonial_image"><img src="assets/img/user_3.jpg" alt=""></div>
					...
					<div class="booking_slider_container">
						<div class="owl-carousel owl-theme booking_slider">
							...
							<div class="booking_item">
								<div class="background_image" style="background-image:url(assets/img/booking_1.jpg)"></div>
							...
							<!-- Slide -->
							<div class="booking_item">
								<div class="background_image" style="background-image:url(assets/img/booking_2.jpg)"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_price">$120/Night</div>
							...
							<!-- Slide -->
							<div class="booking_item">
								<div class="background_image" style="background-image:url(assets/img/booking_3.jpg)"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_price">$120/Night</div>
		...
		<div class="blog_slider_container">
			<div class="owl-carousel owl-theme blog_slider">
				...
				<div class="blog_slide">
					<div class="background_image" style="background-image:url(assets/img/index_blog_1.jpg)"></div>
				...
				<!-- Slide -->
				<div class="blog_slide">
					<div class="background_image" style="background-image:url(assets/img/index_blog_2.jpg)"></div>
					<div class="blog_content">
						<div class="blog_date"><a href="#">Oct 20, 2018</a></div>
				...
				<!-- Slide -->
				<div class="blog_slide">
					<div class="background_image" style="background-image:url(assets/img/index_blog_3.jpg)"></div>
					<div class="blog_content">
						<div class="blog_date"><a href="#">Oct 20, 2018</a></div>
				...
				<div class="row footer_row">
					...
					<div class="col-lg-3">
						<div class="certificates d-flex flex-row align-items-start justify-content-lg-between justify-content-start flex-lg-nowrap flex-wrap">
							<div class="cert"><img src="assets/img/cert_1.png" alt=""></div>
							<div class="cert"><img src="assets/img/cert_2.png" alt=""></div>
						</div>
					</div>
				</div>
			</div>
...
<script src="assets/css/bootstrap-4.1.2/popper.js"></script>
<script src="assets/css/bootstrap-4.1.2/bootstrap.min.js"></script>
