...
@section('main')
			...
			<div class="row">
				...
				<div class="col-xl-7 col-lg-6">
					<div class="details_image">
						<div class="background_image" style="background-image:url(assets/img/details_1.jpg)"></div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xl-7 col-lg-6 order-lg-2 order-1">
					<div class="details_image">
						<div class="background_image" style="background-image:url(assets/img/details_2.jpg)"></div>
					</div>
				</div>
	...
	<div class="special">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="assets/img/special.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
